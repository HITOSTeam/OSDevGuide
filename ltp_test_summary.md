...
| Bind mounts         | fs_bind[01-24].sh, fs_bind_rbind[01-39].sh, fs_bind_move[01-22].sh, fs_bind_cloneNS[01-07].sh ◐ 2026-03-20 first bind propagation batch (`fs_bind01-08` PASS on musl+glibc after live namespace propagation fanout + stacked bind cleanup fix) |
...
1. `fs_bind_rbind*` / `fs_bind_move*` propagation follow-up after `fs_bind01-08`
